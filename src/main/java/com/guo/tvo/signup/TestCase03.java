...
/**
 * TestCase03 : For  Last Name - Positive testing for the SignUp functionality. 
 * 
 * @author Leping Guo
 *
 */
...
public class TestCase03
{
    public static void main( String[] args ) throws IOException
    {
        ...
        String csvFile ="./dataSource/lastNamePositiveData.csv";
       ...
       driver.close();
       System.out.println("TestCase03 got the expected result!"); 
    }
}
