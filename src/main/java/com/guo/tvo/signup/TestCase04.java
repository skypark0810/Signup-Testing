...
/**
 * Test Case 04 : For First Name - Negative testing for the SignUp functionality. 
 * 
 * @author Leping Guo
 *
 */
...
public class TestCase04
{
    public static void main( String[] args ) throws IOException, InterruptedException
    {
        ...
        String csvFile ="./dataSource/firstNameNegativeData.csv";
       ...
       driver.close();
       System.out.println("TestCase04 compeleted successfully!"); 
    }
}
