...
/**
 * Test Case 06 : Email  - Negative testing for the SignUp functionality. 
 *
 * @author Leping Guo
 *
 */
...
public class TestCase06
{
    public static void main( String[] args ) throws IOException, InterruptedException
    {
        ...
        String csvFile ="./dataSource/emailNegativeData.csv";
       ...
       try{
	        ...
	        while ((line = br.readLine()) != null) {
		        ...
		        String email = signupInfo[1];
		        String confirmEmail = signupInfo[2];
		        ...
		        driver.findElement(By.id("userEmailConfirm")).sendKeys(confirmEmail); // using parameter of Confirm Email
		        Thread.sleep(5000);
       ...
       driver.close();
       System.out.println("TestCase06 compeleted successfully!"); 
    }
}
